...
Keywords: Artificial Intelligence (AI), Artificial Moral Agents (AMAs), responsibility gap, rational belief, relational responsibility

時間：2025年3月31日（星期一）下午2:30

地點：中研院歐美所一樓會議室`,
  content_en: `Topic: "Artificial Intelligence and Artificial Moral Agents"
