...
export const event: Event = {
  id: "lecture-2026-07-13",
  date: "2026-07-13",
  year: "2026",
  type: "Lecture",
  image: "/images/events/2026/lecture-2026-07-13.jpg",
  title_zh: "民主韌性對抗外國資訊操弄與干預行動：從臺灣經驗出發",
  title_en: "Democratic Resilience Against Foreign Information Manipulation and Interference Operations: Lessons from Taiwan's Experience",
  content_zh: `
...
Venue: 1st Floor Conference Room, Institute of European and American Studies, Academia Sinica
  `,
  speakers: [
    { name_zh: "羅埃尼", name_en: "Enescan Lorci", affiliation_zh: "臺灣民主基金會訪問學人", affiliation_en: "Visiting Fellow, Taiwan Foundation for Democracy" },
    { member: "tzu-wei-hung" },
    { name_zh: "林昕璇", name_en: "Hsin-Hsuan Lin", affiliation_zh: "國立成功大學", affiliation_en: "National Cheng Kung University" },
    { member: "chih-hsing-ho" },
  ],
  abstract_zh: `數位平台的興起加劇了外國資訊操弄與干預（FIMI）的威脅，尤其來自中國等威權政權。不同於可能出於無意的錯誤資訊，或僅限國內的假訊息，FIMI代表的是外國行為者為破壞民主制度並影響政治結果而進行的協調性戰略行動。過去十年來，臺灣一直是中國FIMI行動的主要目標，持續面臨操弄民主程序、左右臺灣民眾傾向統一之輿論的企圖。儘管面臨這些持續挑戰，臺灣已成功透過涵蓋政府、公民社會、公共媒體與學術界的「全社會」途徑，建立起對FIMI的強韌抵禦能力。本文探討臺灣在對抗FIMI方面的獨特經驗，突顯其韌性中的策略與參與者。透過檢視臺灣的方法，本文旨在提供其他民主國家可借鑑的寶貴洞見與經驗，以保護自身免受類似的外國影響力行動。`,
