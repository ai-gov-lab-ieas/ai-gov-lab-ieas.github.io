...
export const CONTENT = {
  zh: {
    ...
    mission: {
      ...
      view_all: "查看全文",
      modal_close: "關閉",
      full_text: "近年來隨著人工智慧（AI）技術的快速發展，AI已深刻影響了我們日常生活的各個面向。2022年底生成式人工智慧 (Generative AI) 伴隨大型語言模型 (Large Language Models, LLMs) 的問世，帶來了自然語言處理、文字圖像生成與AI製造等多個領域的廣泛應用，將AI的發展帶入了新的紀元。然而，AI的快速發展也伴隨著對於人類文明、社會規範、經濟結構、甚至民主法治等諸多核心價值的重要挑戰，藉由演算法而日益加深的社會歧見、數位監控 (digital surveillance) 與精準投放、假新聞的傳播與深偽技術 (deep fake) 的濫用等，如何回歸以人為本、建立可信任的人工智慧 (trustworthy AI)，並藉由AI治理回應AI技術所帶來人類文明和民主社會的潛在影響，是這個實驗室所欲成立的初衷。\n\n歐美所AI治理觀念實驗室的成立，將就AI治理的重要議題進行各個面向廣泛而深入的研究，從個人隱私、資料保護與資料治理、演算法之透明與可解釋性，到自動化決策因果關係之探討、認知科學與避免歧見、人類知識與智慧之思辨，人機互動與責任分配，以及AI倫理與規範之建立等。我們希望能以更為開放多元的態度，藉由不同學科，包含法律、法理學、認知哲學、知識論、倫理學與資訊工程的角度出發，透過跨領域的學術對話建立所內與所外的橫向連結，就AI治理的重要議題展開思辨。\n\n以生成式AI的治理為例，今年夏季甫通過的歐盟人工智慧法案 (AI Act) 仍以風險高低作為AI的監理原則，此一規範模式卻難以應對大型語言模型應用下，使用者之角色深化，以及風險和責任分配不平等的權力關係。再者，目前歐盟的治理機制尚未能考慮到全球不同語言使用與其文化脈絡之間的特殊性，以及敘事和語境隱喻間的深層關聯。作為世界上繁體中文的主要使用者，臺灣在生成式人工智慧國際規範的制定上有其重要的意義。AI治理觀念實驗室也將積極投入生成式AI的治理，藉由全球規範和在地形制的對話，進一步豐富全球AI治理的討論。我們希望能藉此雙重視角，一方面著眼於全球AI規範的發展，與歐美思潮和AI國際治理規範進行對話；另一方面則含納在地形制的特殊性，避免以歐美視角為中心所產生的框架或侷限。此一研究取徑，因帶入了不同社會脈絡的視野、能動者、結構與文化，將在比較、對話與轉譯間重新開創新穎並具有原創性的歐美研究。這樣的視野與維度將更能豐富傳統以區域研究為中心的歐美研究，使其更具包容性、原創性與批判性，也能讓AI治理的討論更為開放和多元。\n\n跳脫框架的想像和嘗試本即是促成此一雙重視野的重要契機，而實驗室不同背景和多元成員的組成，則是促成想像發揮的基本條件。我們希望這個觀念實驗室能因成員背景的多元性，以不同的角度看待AI治理，最終更希望能藉由不同學科和理論之間的互動和探索，激盪創生新的想法，並對AI治理的諸多議題提出學術理論、分析與建言，以回應AI技術對於人類文明和未來社會所造成的迫切衝擊。",
      box1_title: "AI 挑戰與影響",
      box1_icon: "⚡",
      box1_preview: "AI的快速發展伴隨著對於人類文明、社會規範、經濟結構、甚至民主法治等諸多核心價值的重要挑戰。",
      box1_full: "近年來隨著人工智慧（AI）技術的快速發展，AI已深刻影響了我們日常生活的各個面向。2022年底生成式人工智慧 (Generative AI) 伴隨大型語言模型 (Large Language Models, LLMs) 的問世，帶來了自然語言處理、文字圖像生成與AI製造等多個領域的廣泛應用，將AI的發展帶入了新的紀元。然而，AI的快速發展也伴隨著對於人類文明、社會規範、經濟結構、甚至民主法治等諸多核心價值的重要挑戰，藉由演算法而日益加深的社會歧見、數位監控 (digital surveillance) 與精準投放、假新聞的傳播與深偽技術 (deep fake) 的濫用等，如何回歸以人為本、建立可信任的人工智慧 (trustworthy AI)，並藉由AI治理回應AI技術所帶來人類文明和民主社會的潛在影響，是這個實驗室所欲成立的初衷。",
      box2_title: "可信任AI與研究創新",
      box2_icon: "🔒",
      box2_preview: "如何回歸以人為本、建立可信任的人工智慧 (trustworthy AI)，並藉由AI治理回應AI技術所帶來人類文明和民主社會的潛在影響。",
      box2_full: "歐美所AI治理觀念實驗室的成立，將就AI治理的重要議題進行各個面向廣泛而深入的研究，從個人隱私、資料保護與資料治理、演算法之透明與可解釋性，到自動化決策因果關係之探討、認知科學與避免歧見、人類知識與智慧之思辨，人機互動與責任分配，以及AI倫理與規範之建立等。我們希望能以更為開放多元的態度，藉由不同學科，包含法律、法理學、認知哲學、知識論、倫理學與資訊工程的角度出發，透過跨領域的學術對話建立所內與所外的橫向連結，就AI治理的重要議題展開思辨。此一研究取徑，因帶入了不同社會脈絡的視野、能動者、結構與文化，將在比較、對話與轉譯間重新開創新穎並具有原創性的歐美研究。這樣的視野與維度將更能豐富傳統以區域研究為中心的歐美研究，使其更具包容性、原創性與批判性，也能讓AI治理的討論更為開放和多元。",
      box3_title: "跨領域研究與創新想像",
      box3_icon: "🧠",
      box3_preview: "跳脫框架的想像和嘗試本即是促成此一雙重視野的重要契機，而實驗室不同背景和多元成員的組成，則是促成想像發揮的基本條件。",
      box3_full: "跳脫框架的想像和嘗試本即是促成此一雙重視野的重要契機，而實驗室不同背景和多元成員的組成，則是促成想像發揮的基本條件。我們希望這個觀念實驗室能因成員背景的多元性，以不同的角度看待AI治理，最終更希望能藉由不同學科和理論之間的互動和探索，激盪創生新的想法，並對AI治理的諸多議題提出學術理論、分析與建言，以回應AI技術對於人類文明和未來社會所造成的迫切衝擊。我們希望能藉此雙重視角，一方面著眼於全球AI規範的發展，與歐美思潮和AI國際治理規範進行對話；另一方面則含納在地形制的特殊性，避免以歐美視角為中心所產生的框架或侷限。"
    },
    team: {
      title: "參與成員",
      subtitle: "",
