...
export const MEMBERS: Member[] = [
  {
    ...
    bio_en:
      'Chih-Hsing Ho is an Associate Research Fellow at the Institute of European and American Studies, Academia Sinica, tenured since February 2021, and coordinates the AI Governance Laboratory. She holds a Ph.D. in Law from the London School of Economics, a J.S.M. from Stanford Law School, an LL.M. from Columbia Law School, and an LL.B. from National Taiwan University. Her research spans translational medicine and biobanking law, data protection law, AI governance and law, law and global health, and law and anthropology. She has also been a Research Fellow at the Centre for Medical Ethics and Law, University of Hong Kong, since 2019, and has repeatedly received the National Science and Technology Council Award for Outstanding Scholars.',
  ...
  },
  {
    ...
    bio_en:
      'Cheng-Hung Tsai is a Research Fellow at the Institute of European and American Studies, Academia Sinica, where he has worked since 2018. He earned his Ph.D. in Philosophy from National Taiwan University in 2006, with a dissertation on virtue semantics and linguistic understanding. His research covers philosophy of intelligent action, epistemology, virtue theory, philosophy of language and mind, practical wisdom, and AI and machine ethics. He developed three frameworks: virtue semantics, a hybrid-skill theory of practical knowledge, and an expertise theory of wisdom. He is Editor-in-Chief of EurAmerica since 2023 and previously directed the Taiwan Philosophical Association. He received the Outstanding Research Award from the National Science and Technology Council in 2025 and the Ta-You Wu Memorial Award in 2014.',
  ...
  },
  {
    ...
    bio_en:
      'Tzu-Wei Hung is a Research Fellow at the Institute of European and American Studies, Academia Sinica, where he has worked since 2023. He holds a Ph.D. in Philosophy from King\'s College London (2011), an MPhilStud in Philosophy of Psychology from the same institution (2007), and a B.A. in Philosophy from National Taiwan University (1999). His research spans cognitive science, language, and AI philosophy, social philosophy, and Taiwanese philosophy, emphasizing predictive processing, algorithmic fairness, cognitive warfare, and Taiwanese philosophical thought. He served as President of the Taiwan Philosophical Association (2024–2026), edits the Centennial Anthology of Taiwanese Philosophy Series, and sits on Academia Sinica\'s Generative AI Advisory Committee. He received the National Science and Technology Council\'s Outstanding Research Award for 2022–2023.',
